                ...
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link" href="stock.php">
                            <div class="sb-nav-link-icon"><i class="fas fa-archive" style="color:black"></i></div>
                            FOOD STOCK
                        </a>
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4 mb-3">Import Excel</h1>
                    <div style="margin:auto;width: 600px;padding: 20px;">
                        <form action="" method="POST" enctype="multipart/form-data" class="row g-2">
                            ...
                            <a href="stockFormat.xlsx">Download Format</a>
                        </form>
                        <hr>
                        <table id="datatablesSimple">
                            ...
                            <?php
                            $i = 1;
                            $rows = mysqli_query($conn, "SELECT * FROM produk");
                            foreach ($rows as $row) :
                            ?>
                                <tr>
                                    <td> <?php echo $i++; ?> </td>
                        ...
                        if (isset($_POST["import"])) {
                            ...
                            $skipRows = 2; // Menentukan jumlah baris yang akan di-skip
                            $skipCounter = 0;

                            foreach ($reader as $key => $row) {
                                // Skip jumlah baris yang ditentukan
                                ...
                                $harga = $row[3];
                                $stock = $row[4];
                                mysqli_query($conn, "INSERT INTO produk VALUES('', '$namaproduk', '$deskripsi', '$harga', '$stock')");
                            }
